# Based on https://github.com/lablabs/terraform-aws-eks-alb-ingress/blob/master/iam.tf
...
resource "aws_iam_policy" "alb_ingress" {
  name        = "${var.cluster_name}-alb-ingress2"
  path        = "/"
...
data "aws_iam_policy_document" "alb_ingress_assume" {
  statement {
    ...
    condition {
      ...
      values = [
        "system:serviceaccount:pwh-project:aws-alb-ingress-controller",
      ]
    }
